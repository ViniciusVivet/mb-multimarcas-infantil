        ...
        <section className="grid bg-white lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="px-4 py-8 sm:px-8 lg:px-12 lg:py-14">
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              ...
              <div className="rounded-2xl border-2 border-line bg-paper px-4 py-2.5">
                <p className="text-[10px] font-bold uppercase tracking-widest text-muted">Tamanhos</p>
                <p className="mt-0.5 text-sm font-extrabold text-ink">{product.sizes.join(" · ")}</p>
              </div>
            </div>
